...
INSERT INTO students (id, register_no, name, department, year, email, password, photo, status)
VALUES 
(1, '2026CSE001', 'Alice Vance', 'Computer Science', 'III Year', 'alice@gmail.com', '$2a$10$RxBOfZlFzfxdsOyIYsI7g.WE12rmcP1kwNwmFhGaC40J2aWlZz1G.', 'default-student.png', 'ENABLED'),
(2, '2026CSE002', 'Bob Smith', 'Computer Science', 'III Year', 'bob@gmail.com', '$2a$10$RxBOfZlFzfxdsOyIYsI7g.WE12rmcP1kwNwmFhGaC40J2aWlZz1G.', 'default-student.png', 'ENABLED'),
(3, '2026CSE003', 'Charlie Brown', 'Computer Science', 'II Year', 'charlie@gmail.com', '$2a$10$RxBOfZlFzfxdsOyIYsI7g.WE12rmcP1kwNwmFhGaC40J2aWlZz1G.', 'default-student.png', 'ENABLED'),
(4, '2026ECE001', 'Diana Prince', 'Electronics & Comm', 'IV Year', 'diana@gmail.com', '$2a$10$RxBOfZlFzfxdsOyIYsI7g.WE12rmcP1kwNwmFhGaC40J2aWlZz1G.', 'default-student.png', 'ENABLED'),
(5, '2026MECH01', 'Evan Wright', 'Mechanical Eng', 'I Year', 'evan@gmail.com', '$2a$10$RxBOfZlFzfxdsOyIYsI7g.WE12rmcP1kwNwmFhGaC40J2aWlZz1G.', 'default-student.png', 'DISABLED');
